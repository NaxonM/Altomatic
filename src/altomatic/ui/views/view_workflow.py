...
def build_tab_workflow(frame: ttk.Frame, state: AppState) -> None:
    ...
    if state.context_text and (initial_text := state.context_text.get()):
        context_entry.delete("1.0", "end")
    ...
    accordion_group = [processing_pane, ocr_pane, output_pane]
